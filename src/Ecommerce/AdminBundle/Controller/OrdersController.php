...
use Ecommerce\AdminBundle\Entity\Orders;
...
class OrdersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $orders = $em->getRepository('EcommerceAdminBundle:Orders')->findAll();
    ...
    {
        $order = new Order();
        $form = $this->createForm('Ecommerce\AdminBundle\Form\OrdersType', $order);
    ...
    {
        $deleteForm = $this->createDeleteForm($order);
        $editForm = $this->createForm('Ecommerce\AdminBundle\Form\OrdersType', $order);
